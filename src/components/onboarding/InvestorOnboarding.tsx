...
export function InvestorOnboarding({ fullName }: { fullName: string }) {
  ...
  return (
    <OnboardShell
      ...
      subtitle="Three quick steps — your firm, your thesis and cheque size, your portfolio. No assessment, no prompts. Founders can reach out, and you can pitch them a note."
    >
